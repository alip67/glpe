...
def main(cmd_opt):
    ...
    if not opt['use_cache']: 
        ...
        torch.save(dataset_enriched, f'{ROOT_DIR}/dataset_enriched.pt')            
    else:
        dataset_enriched = torch.load(f'{ROOT_DIR}/dataset_enriched.pt')
